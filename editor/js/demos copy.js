...
TestSpecialNode.title = "Custom Shapes";  // this is what is listed on the menu when you right-click
...
BillShapesNode.title = "Bill Shapes";
BillShapesNode.title_mode = LiteGraph.TRANSPARENT_TITLE;
BillShapesNode.slot_start_y = 100;
