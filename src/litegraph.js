...
(function(global) {
    ...
    var LiteGraph = (global.LiteGraph = {
        ...
        NODE_WIDTH: 240,  //default node width
        NODE_MIN_WIDTH: 50,
        ...
        dialog_close_on_mouse_leave_delay: 500, //changed from 500
        ...
        */
        ...
        //    console.log('litegraph.js createnode function BEGIN');
        //    console.log('litegraph.js createnode type ' + type);
        //    console.log('litegraph.js createnode title ' + title);
        //    console.log('litegraph.js createnode options ' + options);
        ...
        //    console.log('litegraph.js createnode function END');
        //    console.log('litegraph.js createnode type ' + type);
        //    console.log('litegraph.js createnode title ' + title);
        //    console.log('litegraph.js createnode options ' + options);
            return node;
    ...
    //    console.log('in LGraph.prototype.change = function()');
        if (LiteGraph.debug) {
...
*/
    ...
    LGraphNode.prototype.computeSize = function(out) {
        ...
        size[1] += 6; //margin
    //    console.log('in computeSize function');
...
*/
    ...
    function DragAndScale(element, skip_events) {
     //   console.log('function DragAndScale(element, skip_events)');
    ...
    DragAndScale.prototype.bindEvents = function(element) {
        ...
        console.log('DragAndScale.prototype.bindEvents binding events ', element);
	...
	//	console.log("DragAndScale.prototype.computeVisibleArea");
   // console.log('DragAndScale.prototype.computeVisibleArea functionviewport ', viewport);
        if (!this.element) {
    ...
    DragAndScale.prototype.onMouse = function(e) {
        ...
        //    console.log('in litegraph.js process mouse down event');
            this.dragging = true;
    ...
    //    console.log('=======DragAndScale.prototype.toCanvasContext ctx=', ctx);
        ctx.scale(this.scale, this.scale);
        ctx.translate(this.offset[0], this.offset[1]);
    };

    DragAndScale.prototype.convertOffsetToCanvas = function(pos) {
        console.log('=======DragAndScale.prototype.convertOffsetToCanvas');
    ...
    DragAndScale.prototype.convertCanvasToOffset = function(pos, out) {
        out = out || [0, 0];
                console.log('=======DragAndScale.prototype.convertCanvasToOffset');
        console.log('=======pos ' + pos[0] + ' ' + pos[1]);
    ...
    DragAndScale.prototype.mouseDrag = function(x, y) {
        console.log('DragAndScale.prototype.mouseDrag');
    ...
    DragAndScale.prototype.changeScale = function(value, zooming_center) {
        console.log('DragAndScale.prototype.changeScale ZOOMING');
    ...
    DragAndScale.prototype.changeDeltaScale = function(value, zooming_center) {
        ...
        console.log('in DragAndScale.prototype.changeDeltaScale');
    };
    ...
    function LGraphCanvas(canvas, graph, options) {
        ...
        this.billPanAmount = [0,0];
        this.BillMouseDownPos=[0,0];
    ...
    LGraphCanvas.prototype.bindEvents = function() {
        ...
        //added by BD 2303
    //    canvas.addEventListener('paste', e => { console.log('canvas paste event noted')});
    //    LiteGraph.addEventListener('paste', e => { console.log('LiteGraph paste event noted')});
    ...
    //    this.canvas.removeEventListener("blur", this._key_callback);
        //touch events -- THIS WAY DOES NOT WORK, finish implementing pointerevents, than clean the touchevents
	...
	*/
    ...
    //    console.log('mouse down');
        this.adjustBillMouseEvent(e);
        
        this.BillMouseDownPos[0] = e.clientX;
        this.BillMouseDownPos[1] = e.clientY;
		...
		console.log("xxx pointerevents: processMouseDown pointerId:"+e.pointerId+" which:"+e.which+" isPrimary:"+e.isPrimary+" :: x y "+x+" "+y);
        ...
        if (e.which == 1 && !this.pointer_is_double)
		{
            ...
            if (node && (this.allow_interaction || node.flags.allow_interaction) && !skip_action && !this.read_only) {
                ...
                if (!skip_action) {
                    ...
                    //widgets
                    var widget = this.processBillNodeWidgets( node, this.graph_mouse, e );
                    if (widget) {
	...
	*/
    ...
    //    console.log("LGraphCanvas.prototype.processMouseMove event=",e);
    //    console.log("LGraphCanvas.prototype.processMouseMove this=",this);
        if (this.autoresize) {
            this.resize();
        }
      ...
      //  console.log("yyy pointerevents: processMouseMove "+e.pointerId+" "+e.isPrimary, e.last_mouse_dragging);
    ...
    //    	console.log("pointerevents: processMouseMove is dragging_canvas");
        ...
        //        console.log('if (this.resizing_node && !this.live_mode)');
    ...
    LGraphCanvas.prototype.processMouseUp = function(e) {
     ...
     //   console.log('mouse up');
        ...
        this.billPanAmount[0]=e.clientX-this.BillMouseDownPos[0];
        this.billPanAmount[1]=e.clientY-this.BillMouseDownPos[1];
        
      //  console.log('mouse panned=', this.billPanAmount);
        ...
        if (e.which == 1) {
			...
			if( this.node_widget )
			{
				this.processBillNodeWidgets( this.node_widget[0], this.graph_mouse, e );
			}
    ...
    LGraphCanvas.prototype.processMouseWheel = function(e) {
        ...
        console.log('LGraphCanvas.prototype.processMouseWheel processing mouse SCROLL');
    //    this.blur();
    //    this.graph.focus();
    ...
    //    console.log('processMouseWheel start scale is '+ scale);
    //    console.log('processMouseWheel start delta is ' + delta);
        if (delta > 0) {
            scale *= 1.1;
        } else if (delta < 0) {
            scale *= 1 / 1.1;
        ...
        e.preventDefault();
    //    console.log('processMouseWheel end scale is '+ scale);
    //    console.log('processMouseWheel end delta is ' + delta);
	...
	var clientX_rel = 0;  //how far we have dragged x
    var clientY_rel = 0; // how far we have dragged y
    ...
    //    this.billPanAmount[0] = clientX_rel;
      //  this.billPanAmount[1] = clientY_rel;

        e.canvasX = clientX_rel / this.ds.scale - this.ds.offset[0];
        e.canvasY = clientY_rel / this.ds.scale - this.ds.offset[1];
        
    //    console.log("pointerevents: adjustMouseEvent e.clientX="+e.clientX+", e.clientY="+e.clientY+", clientX_rel="+clientX_rel+", clientY_rel="+clientY_rel);
    };

    LGraphCanvas.prototype.adjustBillMouseEvent = function(e) {
    //    console.log('adjustBillMouseEvent - mouse event', e);
        var clientX_rel = 0;
        var clientY_rel = 0;
        ...
        //    console.log('clientX_rel='+ clientX_rel+', clientY_rel='+ clientY_rel);
        //    console.log('e.canvasX='+ e.canvasX+',e.canvasY='+ e.canvasY);
        
        //    console.log("pointerevents: adjustBillMouseEvent e.clientX="+e.clientX+", e.clientY="+e.clientY+", clientX_rel="+clientX_rel+", clientY_rel="+clientY_rel);
        };
    ...
    LGraphCanvas.prototype.setZoom = function(value, zooming_center) {
        console.log('setting zooming this does not get called ?');
	...
	*/
    ...
    LGraphCanvas.prototype.drawFrontCanvas = function() {
        ...
        if (this.graph) {
            ...
            for (var i = 0; i < visible_nodes.length; ++i) {
                ...
                //Draw
                this.drawBillNode(node, ctx);
             //   console.log('in drawFrontCanvas, this.drawBillNode(node, ctx);');
                drawn_nodes += 1;
    ...
    //    console.log('in LGraphCanvas.prototype.drawBackCanvas');
    ...
    LGraphCanvas.prototype.drawNodeShape = function(
      ...
      //  console.log('in LGraphCanvas.prototype.drawNodeShape='+node.title);
        //bg rect
        ...
        for (var i = 0; i < widgets.length; ++i) {
            ...
            switch (w.type) {
                ...
                case "text":  //bd change 325pm
                    ...
                    ctx.fillStyle = background_color;
                    ctx.beginPath();
                    console.log("margin, y, widget_width - margin * 2, H = " + margin + ", " + y + ", " + (widget_width - margin * 2) + ", " + H );
                    if (show_text)
	                    ctx.roundRect(margin, y, widget_width - margin * 2, H, [H * 0.5]);
					else
	                    ctx.rect( margin, y, widget_width - margin * 2, H );
                    ctx.fill();
//                    console.log('hopefully here');  //this stuff gets executed ONLY if there is an input text box
	                if (show_text) {
						if(!w.disabled)
							ctx.stroke();
    					ctx.save();
    ...
    LGraphCanvas.prototype.processNodeWidgets = function(
        ...
        for (var i = 0; i < node.widgets.length; ++i) {
			...
			switch (w.type) {
				...
				case "text":
					if (event.type == LiteGraph.pointerevents_method+"down") {
//						this.billPrompt("SValue",w.value,function(v) {
                        this.prompt("SValue",w.value,function(v) {
								inner_value_change(this, v);
							}.bind(w),
    ...
    LGraphCanvas.onNodeAlign = function(value, options, event, prev_menu, node) {
        console.log('LGraphCanvas.onNodeAlign calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.onGroupAlign = function(value, options, event, prev_menu) {
        console.log('LGraphCanvas.onGroupAlign calling new LiteGraph.ContextMenu');
        new LiteGraph.ContextMenu(["Top", "Bottom", "Left", "Right"], {
            event: event,
            callback: inner_clicked,
            parentMenu: prev_menu,
    ...
    LGraphCanvas.onMenuAdd = function (node, options, e, prev_menu, callback) {
        ...
        console.log('LGraphCanvas.onMenuAdd calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.showMenuNodeOptionalInputs = function(
        ...
        console.log('LGraphCanvas.showMenuNodeOptionalInputs calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.showMenuNodeOptionalOutputs = function(
        ...
        console.log('LGraphCanvas.showMenuNodeOptionalOutputs calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.onShowMenuNodeProperties = function(
        ...
        console.log('LGraphCanvas.onShowMenuNodeProperties calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.prototype.showLinkMenu = function(link, e) {
        ...
        console.log('LGraphCanvas.prototype.showLinkMenu calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.prototype.showConnectionMenu = function(optPass) { // addNodeMenu for connection
        ...
        console.log('******* LGraphCanvas.prototype.showConnectionMenu calling var menu = new LiteGraph.ContextMen');
		// build menu
        var menu = new LiteGraph.ContextMenu(options, {
            event: opts.e,
    ...
    LGraphCanvas.prototype.prompt = function(title, value, callback, event, multiline) {
        ...
        var input_html = "";
        title = title || "";
        console.log('drawing dialog box');
        var dialog = document.createElement("div");
        dialog.is_modified = false;
        dialog.className = "graphdialog rounded";
        if(multiline)
	        dialog.innerHTML = "<span class='name'></span> <textarea id='gggg' autofocus class='value'></textarea><button class='rounded'>8G</button>";
		else
        	dialog.innerHTML = "<span class='name'></span> <input autofocus type='text' class='value'/><button class='rounded'>O2</button>";  //bd this is the dialog box
        dialog.close = function() {
    ...
    LGraphCanvas.prototype.showSearchBox = function(event, options) {
		...
		console.log('in LGraphCanvas.prototype.showSearchBox');
    ...
    LGraphCanvas.prototype.createDialog = function(html, options) {
        ...
        var dialog = document.createElement("div");
        dialog.className = "billgraphdialog";
        ...
        console.log('litegrapgh.js createDialog function');
	...
	LGraphCanvas.prototype.createPanel = function(title, options) {
        ...
        root.addCryptoButton = function( name, callback, options )
{
	var elem = document.createElement("cryptoAddressButton");
	elem.innerText = name;
	elem.options = options;
	elem.classList.add("btn");
	elem.addEventListener("click",callback);
    ...
    LGraphCanvas.onMenuNodeMode = function(value, options, e, menu, node) {
        ...
        console.log('LGraphCanvas.onMenuNodeMode calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.onMenuNodeColors = function(value, options, e, menu, node) {
        ...
        console.log('LGraphCanvas.onMenuNodeColors calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.onMenuNodeShapes = function(value, options, e, menu, node) {
        ...
        console.log('LGraphCanvas.onMenuNodeShapes calling new LiteGraph.ContextMenu');
    ...
    LGraphCanvas.prototype.processContextMenu = function(node, event) {
        ...
        console.log('LGraphCanvas.prototype.processContextMenu = function(node, event)');
        ...
        console.log('this is where processContextMenu calls new LiteGraph.ContextMenu');
    ...
    //    console.log("caller is " + arguments.callee.caller.toString());
        console.log('in function ContextMenu - creating the submenu');
        console.log('values', values);
        console.log('options', options);
    //    console.log('caller is ', this.parent);
    //    console.log('options.parentmenu', options.parentMenu);
	...
	LiteGraph.pointerListenerAdd = function(oDOM, sEvIn, fCall, capture=false) {
		...
		if (sMethod=="pointer" && !window.PointerEvent){ 
			...
			switch(sEvent){
				case "down":{
					sMethod = "touch";
					sEvent = "start";
                    console.log('case: downdown' + sEvent);
					break;
				}
				case "move":{
					sMethod = "touch";
		...
		switch(sEvent){
            ...
            //    console.log('case: ' + sEvent);
			}
			// only pointerevents
			case "leave": case "cancel": case "gotpointercapture": case "lostpointercapture":
			{
				if (sMethod!="mouse"){
                //    console.log('mouslistener');
